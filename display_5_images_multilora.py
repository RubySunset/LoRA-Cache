...
def load_image_groups(directory, group_size=5):
    ...
    for file in image_files:
        ...
        elif 'composite_3' in file:
            composite_3_files.append(file)
        else:
            composite_files.append(file)
    image_groups = []
    for switch, composite, composite_1, composite_2, composite_3 in zip(switch_files, composite_files, composite_1_files, composite_2_files, composite_3_files):
        image_groups.append([switch, composite, composite_1, composite_2, composite_3])
